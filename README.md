...
- **[Сайт-портфолио](https://dangerofjoe.github.io/resume/index.html)** – адаптивный сайт-резюме с якорной навигацией, модальной формой связи, светлым дизайном.  
  `HTML/CSS/JS`
- **[Сайт для компании "ДМ-СТРОЙ"](https://github.com/dangerofjoe/construction-company-s-website)** – приятный сайт с удобной навигацией, модальной формой связи, светлым дизайном.  
  `HTML/CSS/JS`
---
